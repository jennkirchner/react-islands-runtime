...
This app does not hard-fail when Contentstack is missing or invalid.

Current behavior:

- missing credentials: falls back to built-in local content
...
That makes this app useful even before you wire up a real stack.

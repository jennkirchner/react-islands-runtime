...
const testDataStyles = `
	[data-app-theme="test-data"] .app-shell {
		max-width: 1120px;
	}

	[data-app-theme="test-data"] .app-shell__header {
		background:
	...
	[data-app-theme="test-data"] .app-shell__nav a {
	...
	[data-app-theme="test-data"] .theme-mode-switch {
		background:
	...
	html[data-app-theme="test-data"][data-theme-mode="dark"] .app-shell__header {
		background:
	...
	[data-app-theme="test-data"] .app-shell__main {
		gap: 24px;
	}
`;
...
const theme = defineTheme({
	...
	documentProps: {
		htmlAttrs: { 'data-app-theme': 'test-data' },
		styles: createDocumentStyles(carouselStyles, productSearchStyles, testDataStyles),
	},
	modes: {
		dark: {
			colorScheme: 'dark',
...
export const appFeatures = createAppThemeFeatures(theme, { allowAuto: true });
